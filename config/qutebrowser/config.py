...
c.fonts.hints = f'{font_size + 2}pt Iosevka'
c.fonts.statusbar = f'{font_size}pt Iosevka'
c.fonts.downloads = f'{font_size}pt Iosevka'
c.fonts.contextmenu = f'{font_size}pt Iosevka'
c.fonts.tabs.selected = f'{font_size}pt Iosevka'
c.fonts.tabs.unselected = f'{font_size}pt Iosevka'
c.fonts.completion.entry = f'{font_size + 1}pt Iosevka'
c.fonts.completion.category = f'{font_size + 2}pt Iosevka'
...
#c.url.default_page = '~/.config/qutebrowser/home.html'
#c.url.default_page = 'file:////home/lauri/.config/qutebrowser/startpage/index.html'

c.url.start_pages = 'file:////home/lauri/.config/qutebrowser/startpage/index.html'
